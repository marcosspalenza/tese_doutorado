...
Conforme a Tabela \ref{tab-FINDES}, temos alta qualidade de de três classificadores RDF, DTR e GBC. Esse último, em especial, teve o maior desempenho com 78,58\% de ACC. Com 70 respostas e a pluralidade de estruturas textuais encontradas, destacamos a semelhança deste \textit{dataset} com os desafios apresentados por \textit{Beetle} e \textit{SciEntsBank} no ensino de ciências.
