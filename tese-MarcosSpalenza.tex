...
\titulo{\textit{p}Nota: Uma Análise das Componentes Textuais para Avaliação de Respostas Discursivas Curtas}
...
\begin{resumo}
As questões discursivas são um método comum para avaliar o aprendizado do aluno. Muito aplicado no Brasil, este tipo de questão exige ao aluno atender aos requerimentos da atividade de forma escrita livre e direta. Assim, segundo o conteúdo lecionado, é esperado que o aluno seja suscinto e demonstre o aprendizado no tema. Apesar da pequena quantidade de texto produzido, é necessário que o professor avalie cautelosamente todos os alunos para identificar possíveis problemas no aprendizado. O tempo concorrente entre a análise de desempenho dos alunos, planejamento das aulas e atualização dos materiais impossibilita o acompanhamento detalhado do aluno em classe. Deste modo, neste trabalho apresentamos um método de análise e avaliação automática de respostas discursivas para apoiar o trabalho do tutor com redução do tempo de avaliação. Aproveitando-se de técnicas de Aprendizado de Máquina para avaliação, esperamos que o professor torne-se um auditor das atividades, concentrando-se na verificação dos resultados obtidos. Portanto, o sistema proposto utiliza análise textual e linguística documental com resultados equivalentes aos encontrados entre avaliadores humanos. Os resultados obtidos em datasets da literatura apresentam coeficiente Kappa de X\% em relação a tutores humanos.
...
\begin{siglas}
  ...
  \item[SAG] \textit{Short Answer Grader}
\end{siglas}
...
\include{capitulos/ch3-proposta}
